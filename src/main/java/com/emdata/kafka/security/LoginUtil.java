package com.emdata.kafka.security;
...
public class LoginUtil
{
     ...
     * @throws IOException
     */
    public static void setJaasFile(String configDir, String principal, String keytabPath)
        throws IOException
    {
        String jaasPath = configDir + System.getProperty("user.name") + JAAS_POSTFIX;
        
        // windows路径下分隔符替换
        jaasPath = jaasPath.replace("\\", "\\\\");
        System.out.println("jaasPath is :: "+jaasPath);
        // 删除jaas文件
